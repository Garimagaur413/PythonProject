...
class Loginwindow(Tk):
    def __init__(self):
        ...
        style.configure('Header.TLabel', background = 'blue', foreground = 'white', font = (NONE, 25))

        header_label = Label(header_frame, text = "Login", style = 'Header.TLabel')
        ...
        style.configure('Login.TLabel', background = 'white', font = (NONE, 15))
        ...
        self.username_entry = Entry(login_frame, font = (NONE, 15), width = 15)
        self.username_entry.grid(row = 0, column = 1, pady = 5)
        self.username_entry.focus()

        self.password_entry = Entry(login_frame, font = (NONE, 15), width = 15, show = '*')
